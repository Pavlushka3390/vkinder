import sqlalchemy
from foo_vkinder import *
from data_base import User, Photo, create_db
from vk_class import Vkinder, Message
from config import my_token, group_token, DSN
...
def search_result(id_, vki):
    ...
    if check_user(raw_user):
        ...
        photo = [Photo(user_id=new_user.user_id, url=one_url) for one_url in get_best_prof_photos(vki, new_user.user_id)]
...
if __name__ == '__main__':
    ...
    vkinder = Vkinder(token=my_token, group_token=group_token)
